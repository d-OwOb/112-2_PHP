        ...
        <div class="main-form">
            <form action="result.php" method="post">
                <div class="form-row" id="stuId-row">
                    ...
                    <div class="input-area-div"><input type="text" name="stuId" class="input-area"
                            id="stuId-input-area" required></div>
                </div>
                ...
                <div class="form-row" id="gender-row">
                    ...
                    <div class="checkbox-area-div">
                        <input type="radio" name="gender" class="checkbox-area" value="男"><span>男</span
                        ><input type="radio" name="gender" class="checkbox-area" value="女"><span>女</span
                        ><input type="radio" name="gender" class="checkbox-area" value="不願透露" checked><span>不願透露</span>
                    </div>
                </div>
                ...
                <div class="form-row last-row" id="adv-row">
                    ...
                    <div class="advice-area-div"><textarea name="adv" id="adv-input-area" cols="8" rows="10"></textarea></div>
                </div>
